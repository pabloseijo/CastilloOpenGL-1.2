...
int myCubo()
{
	...
	glTexCoord2f(0.0f, 0.0f); glVertex3f(-2.0, -1.0, 1.0);
	glTexCoord2f(1.0f, 0.0f); glVertex3f(2.0, -1.0, 1.0);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(2.0, 1.0, 1.0);

	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(2.0, 1.0, 1.0);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(-2.0, 1.0, 1.0);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(-2.0, -1.0, 1.0);
	...
	glTexCoord2f(0.0f, 0.0f);
	glVertex3f(-2.0, 1.0, 1.0); // vértice superior izquierdo
	glTexCoord2f(0.0f, 1.0f);
	glVertex3f(2.0, 1.0, 1.0); // vértice superior derecho
	glTexCoord2f(1.0f, 1.0f);
	glVertex3f(2.0, 1.0, -1.0); // vértice inferior derecho

	glNormal3f(0.0, 1.0, 0.0);
	glTexCoord2f(0.0f, 0.0f);
	glVertex3f(2.0, 1.0, -1.0); // vértice inferior derecho
	glTexCoord2f(0.0f, 1.0f);
	glVertex3f(-2.0, 1.0, -1.0); // vértice inferior izquierdo
	glTexCoord2f(0.0, 0.0); glVertex3f(-2.0, 1.0, 1.0); // vértice superior izquierdo

	// Cara inferior
	glNormal3f(0.0, -1.0, 0.0);
	glTexCoord2f(0.0, 0.0); glVertex3f(-2.0, -1.0, -1.0); // vértice inferior izquierdo
	glTexCoord2f(1.0, 0.0); glVertex3f(2.0, -1.0, -1.0); // vértice inferior derecho
	glTexCoord2f(1.0, 1.0); glVertex3f(2.0, -1.0, 1.0); // vértice superior derecho

	glTexCoord2f(1.0, 1.0); glVertex3f(2.0, -1.0, 1.0); // vértice superior derecho
	glTexCoord2f(0.0, 1.0); glVertex3f(-2.0, -1.0, 1.0); // vértice superior izquierdo
	glTexCoord2f(0.0, 0.0); glVertex3f(-2.0, -1.0, -1.0); // vértice inferior izquierdo
